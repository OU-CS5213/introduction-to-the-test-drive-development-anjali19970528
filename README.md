...
First commit : corrected testFillAndExpandWithNegative() testcase
		added testRemoveBiggerThanFail() testcase which fails
		added testStepMultiplierFail() testcase which fails
